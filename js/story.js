const storyList = [
    ...
    { id: `pageStoryBody013`, content: `<p>♬딩동댕동 딩동댕동♬<br><br>"5교시에는 다른 선생님이 오셔서 '학교폭력 예방 교육'을 해주실 거야. 떠들지 않고 귀 쫑긋하고 잘 들어야 한다." <br><br>학교폭력… 예방 교육?<br>갑자기 가슴이 쿵쿵 뛰기 시작했다.<br><br>"4반 여러분,<br>학교폭력에 대한 교육은 많이 받았죠?<br>장난과 학교폭력은 어떻게 구분할 수 있을까요?<br>친구가 괴로워한다면, 그게 바로 학교폭력입니다."<br></p>` },
    ...
    // 03. 최책감의 기억_POPUP
    { id: `pageStoryBody031`, content: `<p>번쩍! 과거의 장면들이,<br>내가 도와주지 못했던 '그 친구'의 얼굴이 머릿속을 스쳐 지나갔다.<br>맞아, 나는 그때의 죄책감 때문에 괴로워하고 있었던 거야.<br>이젠 달라지고 싶어.<br>마음이랑 함께 진짜 방어자가 될 거야!<br></p>` },
...
"아, 진짜 갚겠다고 했잖아.<br>친구끼리 이 정도도 못 도와주냐?"<br><br>큰일이다. 케이를 도와야 할 것 같은데,<br>어떻게 해야할지 모르겠어.<br>.<br>.<br>.<br>빛나야, 저기 친구 표정이 어둡네!<br>무슨 고민이 있는 것 같았어.<br>우리가 도와주어야 할 것 같아.<br>그러려면 먼저 조각을 찾아야 하는 거 기억하지?<br><br>응, 당연하지.<br>조각을 찾게 도와줘.<br><br><b>"이렇게 상대의 돈이나 금품을 요구하면서
   빼앗으려고 하는 행위는 학교폭력의 어떠한 유형일까?"</b></p>` },
    ...
    // 06. 과거로 돌아가다2(테이블찾기)
        { id: `storyAudio06`, content: `<audio src="./sound/audio04.mp3" autoplay controls></audio>` },
...
"안 올릴게, 안 올려!<br>이제 됐지? 얼른 춰봐."<br><br>음악이 나오자마자<br>케이는 몸을 조금씩 움직이기 시작했다.<br>그 모습을 보면서 나와 친구들은<br>마음이 무거웠던 것 같았다.<br><br><br><b>이러한 케이의 상황처럼,<br>상대가 원치 않는 행위 또는 행동을 강제로 하게 하거나<br>자발적으로 하게끔 유도하는 행위는 무엇일까?<br></b></p>` },
    ...
    { id: `pageStoryBody113`, content: `<p>몸을 옆으로 뒤척여 핸드폰을 켰다.<br>톡방에는 여전히 케이가 남아있었다.<br>가슴 한쪽이 계속 아파왔다.<br><br>이 기분은 뭘까.<br><br>교실에서 지민이 무리가 틱톡을 찍을 때<br>케이는 절대 하기 싫어했던 게 분명했어.<br>원치 않는 케이를 억지로 영상에 끌어들인 거였어.<br>그건 완전 폭력이었어.<br>그런데도 나는 나서서 막지 못했어...<br>케이의 도움을 청하는 눈빛을 봤는데도<br>나는 책상에 앉아 꼼짝도 안 했어.<br>왜 나는 용기를 내지 못했던 걸까...<br><br></p>` },
    ...
    { id: `pageStoryBody164`, content: `<p>아니, 배가 아프다고 거짓말하고 학교 안 가고 싶었을 거야.<br>그 채팅방은 나갈 수도 없고<br>마치 철창 속에 갇힌 것처럼 꼼짝할 수 없어 화나고 억울했을거야 <br><br>눈앞에서 괴롭힘 당하는데도<br>아무 말 없는 친구들에게<br>내가 어떻게 도움을 청할 수 있었을까?<br>.<br>.<br>.<br>빛나야, 네 마음속에서 케이를 도와주고 싶은 목소리가 들려.<br>누군가의 웃음을 다시 찾아주려는 그 마음은<br>네 이름처럼 환하게 빛나고 있어.<br><br></p>` },
    { id: `pageStoryBody165`, content: `<img src="./img/img_163.png" alt="storyImage" class="img-fluid">` },
    { id: `pageStoryBody166`, content: `<p>괴롭힘 당하는 친구를 돕는 건<br>사실 그렇게 어려운 게 아니야.<br><br>외로울 때 곁에 있어주고,<br>같이 대화하고,<br><br>기쁨도 슬픔도 함께 나누며<br>옆에서 걸어주는 거야.<br><br>케이의 마음을 이해해줘서 정말 고마워.<br>이제 케이를 도우러 가볼까?<br><br></p>` },
    ...
    { id: `pageStoryBody173`, content: `<p>케이야~<br>우리 오늘 인생네컷 찍기로 했거든?<br>5천원만 빌려줄래?<br><br>"나 오늘은 진짜 돈 없어..."<br><br>수연이는 큰 한숨을 내쉬며 케이를 째려보더니, <br><br>"야 5천원 정도 빌려주기가 그렇게 힘들어?<br>좋아, 그럼 안 줘도 돼.<br>대신 우리랑 같이 놀아줘.<br><br>민수는 신난 얼굴로 케이에게 어깨 동무를 한다.<br><br>"오~ 재밌겠는데?<br>케이야, 우리 또 톡톡 찍을까?<br>이번엔 네가 가운데에 있으면<br>진짜 잘 나올 것 같은데?"<br><br></p>` },
    ...
    { id: `pageStoryBody181`, content: `<p>빛나는 방어자 행동이 적힌 7가지 보석을 찾아보자!<br>영문자물쇠를 풀어서 보석함을 확인해봐!<br></p>` },
    ...
    // 19. 행동조각 획득
    { id: `storyAudio191`, content: `<audio src="./sound/audio19.mp3" autoplay controls></audio>` },
...
"고마워, 마음이 네가 아니었다면<br>나는 여전히 케이를 돕지 못했다는 죄책감에<br>친구들과 떳떳하게 지낼 수 없었을 거야.<br><br>"이제 곧 잠에서 깰 시간이야.<br>7가지 도움 방법을 마음속에 담아뒀으면 해.<br>학교폭력은 언제 어디서든 일어날 수 있으니까!"<br>"응, 꼭 기억할게.<br>이제부터는 학교폭력 방어자로서,<br>용기 있게 행동하는 사람이 될 거야.<br>내 마음속에서 함께해 줘, 마음아!"<br><br>"약속할게. 난 항상 네 마음속에 있을 거니까.<br>다음에 또 만날 수 있기를 바랄게!"<br><br>♬띠리리링 띠리리링♬<br><br>그렇게, 알람 소리가 시끄럽게 울려 꿈에서 깨어났다.<br><br></p>` },
    ...
    { id: `pageStoryBody203`, content: `<p>꿈의 조각 4개를 모두 획득한 '빛나'는 황금 열쇠의 주인공이 되었고,<br>이젠 더는 학교폭력 당하는 친구를 모른 척하지 않는 '방어자'가 되었다.<br><br>오랜만에 상쾌한 마음으로 등교길에 나선다.<br>'실천'하는 용기를 가득 안고, 한 걸음 한 걸음.<br><br></p>` },
    { id: `pageStoryBody204`, content: `<img src="./img/img_202.png" alt="storyImage" class="img-fluid">` },
    { id: `pageStoryBody205`, content: `<p>같은 반 친구를 향한 작은 관심과 도움으로도 큰 힘이 되어줄 수 있다는 사실,<br>어쩌면 따뜻한 말 한마디가 학교폭력을 예방하는 첫걸음이 될 수 있답니다!<br><br>오늘부터 '빛나는' 방어자가 된 여러분을 축하하며,<br><b>마지막 미션까지 모두 완료하는 친구에게 '황금선물'을 드려요!</b><br><br></p>` },
