const storyList = [
    ...
    { id: `pageStoryBody002`, content: `<div class="main-text-box" font-color="black" >[게임 유의사항]<br>1. 본 게임은 서초구청소년상담복지센터 상담버스 서포터즈 '마음지기' 2기가 함께 개발한 참여형 학교폭력예방 공감교육입니다.<br>2. 서초구 찾아가는 상담버스 '마음충전' 방문 시 참여 가능한 프로그램으로 사전 접수를 통해 서초구 내 초등학교에서도 진행 가능합니다.<br>3. 초등학생 전학년(1~6학년)을 대상으로 하나 축제 부스 참여의 경우, 부모 동반 진행 가능합니다.<br>4. 게임 제한 시간은 20분입니다. 시간이 지나면 게임은 즉시 종료됩니다.<br>5. 원활한 게임 진행을 위해 현장에서 '시간예약제'로 운영합니다.<br>※1회당 20분 소요, 최대 6명 참여 가능 / 현장접수<br>6. 본 프로그램은 한국청소년상담복지개발원의 '나는 학교폭력 방어자입니다' 자료를 참고하여 제작하였습니다.<br> · 기획 및 편집: 박수아, 김서현, 김유진, 김정우<br><br><br> 본 게임은 '서초구청소년상담복지센터'와 상담버스 서포터즈 '마음지기'가 함께 개발한 게임이며, 학교폭력 예방 교육 목적으로 제작되었습니다. 또한, 본 게임에 등장하는 등장인물 및 스토리는 모두 픽션이며, 특정 인물이나 사건, 단체 및 조직, 배경 등은 실제와 어떠한 관련도 없음을 알려드립니다.<br>게임 내 삽입된 BGM 및 이미지는 저작권법에 의하여 보호되며, 저작권자의 허가없이 사용을 불허합니다.<dvi>` },
