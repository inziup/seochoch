const storyList = [
    { id: `pageStoryBody001`, content: `<p class="story-text-box"><b>[ 게임 미리보기 ]</b> <br> 어엿한 중학생이 된지 한달이 된 서빛나, 학교생활이 도무지 즐겁지 않은 것 같다.<br>학교폭력예방 교육을 듣고 그날 밤, 빛나의 마음이 쿵쿵 울렸다. 왜 이렇게 가슴이 무거운 걸까? 하지만 점점 무거워지는 눈꺼풀을 이길 수 없다. <br> 빛나는 결국 꿈나라로 떠나는데.. <br> 꿈속에 나타난 귀여운 요정과 함께 마음을 들여다보고, 진정한 친구의 의미를 생각해보게 되는데... 빛나의 용감한 '방어자 되기 대작전'! 우리 모두 함께 떠나볼까?</p>` },
    ...
    { id: `pageStoryBody002`, content: `<div class="main-text-box" font-color="black" >[게임 유의사항]<br>1. 본 게임은 서초구청소년상담복지센터 상담버스 서포터즈 '마음지기' 2기가 함께 개발한 참여형 학교폭력예방 공감교육입니다.<br>2. 서초구 찾아가는 상담버스 '마음충전' 방문 시 참여 가능한 프로그램으로 사전 접수를 통해 서초구 내 초등학교에서도 진행 가능합니다.<br>3. 초등학생 전학년(1~6학년)을 대상으로 하나 축제 부스 참여의 경우, 부모 동반 진행 가능합니다.<br>4. 게임 제한 시간은 20분입니다. 시간이 지나면 게임은 즉시 종료됩니다.<br>5. 원활한 게임 진행을 위해 현장에서 '시간예약제'로 운영합니다.<br>※1회당 20분 소요, 최대 6명 참여 가능 / 현장접수<br>6. 본 프로그램은 한국청소년상담복지개발원의 '나는 학교폭력 방어자입니다' 자료를 참고하여 제작하였습니다.<br> · 기획 및 편집: 박수아, 김서현, 김유진, 김정우<br><br><br> 본 게임은 '서초구청소년상담복지센터'와 상담버스 서포터즈 '마음지기'가 함께 개발한 게임이며, 학교폭력 예방 교육 목적으로 제작되었습니다. 또한, 본 게임에 등장하는 등장인물 및 스토리는 모두 픽션이며, 특정 인물이나 사건, 단체 및 조직, 배경 등은 실제와 어떠한 관련도 없음을 알려드립니다.<br><br>게임 내 삽입된 BGM 및 이미지는 저작권법에 의하여 보호되며, 저작권자의 허가없이 사용을 불허합니다.<dvi>` },
    ...
    // 08. 집에돌아온 후
    { id: `pageStoryBody080`, content: `<h3>집에 돌아온 후</h3><h6>하교 후 마음이 더욱 심란해진 나,<br>단체 채팅방을 확인하니 케이의 영상이 올라와 있었고 웃음거리가 되고 있었다.</h6><hr />` },
